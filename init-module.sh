...
sed -i '' "s/___VARIABLE_moduleName___/${NO_PREFIX_NAME}/g" "IO/Shared/___VARIABLE_moduleName___ID.swift"
...
mv "IO/Shared/___VARIABLE_moduleName___ID.swift" "IO/Shared/${NO_PREFIX_NAME}ID.swift"
